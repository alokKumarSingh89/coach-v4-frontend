 ...
 */
class Membership extends React.Component<PageProps & WithStyles> {
  /**
   * Render method
   */
  render() {
      ...
      <div className={classes.root}>
        ...
        <Paper elevation={0} square className={classes.paper}>
          ...
          <Typography variant="subheading" className={classes.paperSubheading}>
            Choose your degree, price and amount of rewards
          </Typography>
        ...
        <Paper elevation={0} square className={classes.paper}>
          ...
          <Typography variant="subheading" className={classes.paperSubheading}>
            Whole system is free to use but with advantage you are not limited anymore.
          </Typography>
          <Button variant="contained" color="primary" fullWidth size="medium">
            Show more info
          </Button>
...
export default withLayout(Membership, mapPageToLayoutProps(pageProps));
